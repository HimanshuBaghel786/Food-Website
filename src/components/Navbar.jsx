        ...
        <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
           ...
           { /*<div className='hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px]'>
            ...
            <div className='bg-gray-200 flex rounded-full items-center px-2 w-[200px] sm:w-[400px] lg:w-[500px]'>
                ...
                <input className='bg-transparent p-2 focus:outline-none' placeholder='Search foods' type='text' />
            </div>
            ...
            <AiOutlineClose className= 'absolute right-4 top-4 cursor-pointer' size = {30} onClick={()=> setNav(!nav)}/>
                <h2>
                    Best <span className='font-bold'>Food</span>
                </h2>
                <nav>
